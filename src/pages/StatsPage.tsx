      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 py-4 md:py-6 space-y-5 md:space-y-6">
        ...
        {totalMovies === 0 ? (
          ...
          <>
            ...
            {/* Biểu đồ hoạt động */}
            <div className="bg-surface border border-border-default dark:border-white/5 p-4 sm:p-6 rounded-3xl shadow-premium">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Phân bổ đánh giá */}
              <div className="bg-surface border border-border-default dark:border-white/5 p-6 rounded-3xl shadow-premium">
                <div className="flex items-center gap-3 mb-8">
                  <div className="p-2 bg-warning/10 rounded-xl">
                    <Star size={18} className="text-warning" strokeWidth={1.5} />
                  </div>
            ...
            <div className="bg-surface border border-border-default dark:border-white/5 p-6 rounded-3xl shadow-premium">
              <div className="flex items-center gap-3 mb-8">
                <div className="p-2 bg-primary/10 rounded-xl">
                  <Film size={18} className="text-primary" strokeWidth={1.5} />
                </div>
