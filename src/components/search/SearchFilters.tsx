    ...
    <div className="flex flex-col gap-3 sm:gap-4">
      <div className="relative w-full group" ref={containerRef}>
        ...
        {showSuggestions && suggestions.length > 0 && (
          <div className="absolute top-full left-0 right-0 mt-2 bg-surface border border-border-default rounded-2xl shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
            <div className="max-h-[350px] overflow-y-auto py-2 custom-scrollbar">
              <div className="px-4 py-2 text-[10px] font-bold text-text-muted uppercase tracking-wider border-b border-border-default mb-1">
                Gợi ý tìm kiếm
              </div>
              {suggestions.map((movie) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-2.5 hover:bg-black/5 dark:hover:bg-white/5 transition-colors text-left group/item"
                  >
                    <div className="w-10 h-14 rounded-lg overflow-hidden bg-black/5 shrink-0 border border-border-default">
                      <img 
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-0.5">
                        <div className="flex items-center gap-1 text-[11px] text-text-muted">
                          {isTV ? <Tv size={12} className="text-info" /> : <Film size={12} className="text-success" />}
              ...
              <button
                ...
                className="w-full py-3 px-4 mt-1 border-t border-border-default text-primary text-xs font-bold hover:bg-primary/5 transition-colors flex items-center justify-center gap-2"
              >
                <Search size={14} />
