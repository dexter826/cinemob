      ...
      {showCreateAlbum && (
        <div className="flex gap-3 animate-in fade-in slide-in-from-top-2 p-4 bg-black/5 dark:bg-white/5 rounded-2xl border border-border-default shadow-sm">
          <input
            ...
            className="flex-1 bg-surface border border-border-default rounded-xl px-4 py-2.5 text-sm font-medium focus:border-primary/50 focus:ring-1 focus:ring-primary/20 outline-none transition-colors"
            autoFocus
          />
          <button
            type="button"
